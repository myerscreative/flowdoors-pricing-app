  ...
  const getStatusStyles = (status: string) => {
    ...
    const styles = {
      new: {
        ...
        pill: 'bg-gradient-to-r from-green-500 to-emerald-600 text-white border-0 shadow-lg',
        border: 'border-green-400',
        text: 'text-green-700',
      },
      hot: {
        dot: 'bg-gradient-to-r from-red-400 to-pink-500',
        pill: 'bg-gradient-to-r from-red-500 to-pink-600 text-white border-0 shadow-lg',
        border: 'border-red-400',
        text: 'text-red-700',
      },
      warm: {
        dot: 'bg-gradient-to-r from-orange-400 to-amber-500',
        pill: 'bg-gradient-to-r from-orange-500 to-amber-600 text-white border-0 shadow-lg',
        border: 'border-orange-400',
        text: 'text-orange-700',
      },
      cold: {
        dot: 'bg-gradient-to-r from-blue-400 to-indigo-500',
        pill: 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 shadow-lg',
        border: 'border-blue-400',
        text: 'text-blue-700',
      },
      hold: {
        dot: 'bg-gradient-to-r from-purple-400 to-violet-500',
        pill: 'bg-gradient-to-r from-purple-500 to-violet-600 text-white border-0 shadow-lg',
        border: 'border-purple-400',
        text: 'text-purple-700',
      },
      archived: {
        dot: 'bg-gradient-to-r from-gray-400 to-slate-500',
        pill: 'bg-gradient-to-r from-gray-500 to-slate-600 text-white border-0 shadow-lg',
