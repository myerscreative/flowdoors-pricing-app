...
export function initAttribution(): Attribution | undefined {
  ...
  const merged: Attribution = {
    ...
    ...readFbcFbp(),
    landing_page_url:
      first.landing_page_url ?? (window.location.href || undefined),
    referrer: first.referrer ?? (document.referrer || undefined),
...
export async function postLead(payload: LeadPayload): Promise<unknown> {
  ...
  if (endpoint.startsWith('/api/quote/leads')) {
    ...
    try {
      ...
      // swallow errors for local autosave path
    }
    return {}
  }
