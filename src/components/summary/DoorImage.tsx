  ...
  return (
    <div className="flex justify-center mb-8">
      <div className="w-full max-w-4xl flex flex-col items-center">
        ...
        {configImageUrl ? (
          <div className="relative w-full max-w-2xl h-[300px] bg-white rounded-lg shadow-lg border-2 border-gray-200 flex items-center justify-center px-6 py-8">
            <Image
              src={configImageUrl}
          ...
          <div className="relative w-full max-w-2xl h-[300px] bg-gray-100 rounded-lg shadow-lg flex items-center justify-center px-6 py-8">
            <Image
              src={imagePath}
