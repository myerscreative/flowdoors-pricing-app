  ...
  return (
    <div className="flex justify-center mb-8">
      <div className="w-full max-w-4xl flex flex-col items-center">
        ...
        {configImageUrl ? (
          <div className="relative w-full max-w-2xl h-[250px] bg-white rounded-lg overflow-hidden shadow-lg border-2 border-gray-200 flex items-center justify-center p-6 my-[5px]">
            <Image
              src={configImageUrl}
          ...
          <div className="relative w-full max-w-2xl h-[250px] bg-gray-100 rounded-lg overflow-hidden shadow-lg flex items-center justify-center p-6 my-[5px]">
            <Image
              src={imagePath}
